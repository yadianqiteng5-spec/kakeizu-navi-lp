...
PILLARS = [
    ...
    },
    {
        ...
        "groups": [
            ...
            ("放棄・借金・トラブル対応", ["estate-administrator", "inheritance-renounce", "debt-inheritance", "inheritance-trouble", "disinheritance", "renounce-still-receive", "property-division-methods", "division-mediation"]),
    ...
    },
    {
        ...
        "groups": [
            ("だれが相続人になるか（順位と範囲）", ["substitution-inheritance", "legal-heir-info", "siblings-only-inheritance", "only-child-inheritance", "step-family-inheritance"]),
