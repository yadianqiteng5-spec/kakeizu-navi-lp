...
PILLARS = [
    {
        ...
        "groups": [
            ("まず基本を押さえる", ["inheritance-tax", "table-inheritance-tax", "table-basic-deduction", "calculator", "tax-surcharge"]),
            ("評価と特例で税額を下げる", ["small-residential", "real-estate-valuation", "corporate-shares", "nominee-deposit", "leasehold-inheritance"]),
            ("節税の王道：二次相続・生前贈与・保険", ["secondary-inheritance", "gift-strategy", "table-gift-tax", "insurance-strategy", "retirement-money", "education-gift"]),
            ("申告・納税・調査への備え", ["estate-tax-return", "tax-investigation", "deferred-payment", "consecutive-inheritance"]),
        ],
    },
    {
        ...
        "groups": [
            ("全体像と期限をつかむ", ["inheritance-procedure", "post-death-timeline", "table-deadlines", "legal-heir-info"]),
            ("財産の名義変更・解約", ["bank-account-freeze", "real-estate-valuation", "mortgage-inheritance", "estate-division", "digital-legacy"]),
            ("放棄・借金・トラブル対応", ["inheritance-renounce", "debt-inheritance", "inheritance-trouble", "disinheritance"]),
            ("年金・お墓・専門家相談", ["survivor-pension", "grave-succession", "consulting-cost"]),
        ],
    },
    {
    ...
    },
    {
        ...
        "groups": [
            ("遺言書を正しく残す", ["will-template", "notarized-will", "will-rewrite", "will-executor", "legal-reserve"]),
            ("財産の渡し方", ["bequest-gift", "gift-strategy", "education-gift"]),
