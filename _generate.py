...
PILLARS = [
    ...
    },
    {
        ...
        "groups": [
            ...
            ("放棄・借金・トラブル対応", ["limited-acceptance", "renounce-deadline-passed", "division-redo", "renounce-duty", "estate-administrator", "inheritance-renounce", "debt-inheritance", "inheritance-trouble", "disinheritance", "renounce-still-receive", "property-division-methods", "division-mediation"]),
    ...
    },
    {
        ...
        "groups": [
            ("遺言書を正しく残す", ["will-storage-system", "invalid-will", "will-template", "notarized-will", "will-rewrite", "will-executor", "will-probate", "legal-reserve", "will-trust-bank"]),
    ...
    },
    {
        ...
        "groups": [
            ...
            ("兄弟・親族間のトラブル対策", ["inheritance-claim-process", "siblings-dispute", "inheritance-trouble"]),
        ],
    },
    {
        "slug": "guide-koseki",
        ...
        "groups": [
            ("戸籍を集める・取り寄せる", ["koseki-fuhyo", "collect-koseki", "koseki-wide-area", "koseki-removed", "old-koseki-reading"]),
...
# --- 2026-06 SEOギャップ第3弾5記事(遺留分侵害額請求/遺言書保管制度/限定承認/相続放棄3か月超/戸籍の附票) ---
ARTICLES += [{'slug': 'inheritance-claim-process', 'title': '遺留分侵害額請求の進め方｜計算・時効・相手が払わないとき', 'h1': '遺留分侵害額請求の進め方', 'desc': '遺言や生前贈与で遺留分を侵害されたとき、金銭を請求する「遺留分侵害額請求」の進め方を解説。2019年改正で金銭請求になった点、請求できる額の計算、1年の時効、相手が応じないときの調停・訴訟まで整理します。', 'keywords': '遺留分侵害額請求,計算,時効,1年,民法1046条,遺留分', 'lead': '「遺産はすべて長男に」という遺言でも、他の相続人には最低限の取り分=<strong>遺留分</strong>が保障されています。侵害された分を取り戻す<strong>遺留分侵害額請求</strong>の進め方を、計算と期限を中心に整理します。', 'sections': [('2019年改正で「金銭の請求」になった', '<p>かつては遺留分を主張すると不動産などが共有状態になりがちでしたが、2019年7月の改正で、遺留分の侵害は<strong>金銭で精算する権利（遺留分侵害額請求権）</strong>に整理されました（民法1046条）。つまり「不動産の一部をよこせ」ではなく「侵害された分のお金を払って」と請求する形になります。</p>'), ('いくら請求できるか（計算の考え方）', '<p>遺留分の総枠は、相続人が<strong>直系尊属（親など）のみなら遺産の1/3</strong>、<strong>それ以外は1/2</strong>です。これに各人の法定相続分を掛けたものが、その人の遺留分になります。</p><p>例：相続人が子2人で、全財産を一方に渡す遺言があった場合、もう一方の子の遺留分は「1/2 × 1/2 = <strong>1/4</strong>」。遺産が4,000万円なら1,000万円を請求できる計算です（生前贈与なども加味します）。</p>'), ('時効に注意（1年）', '<p>請求には期限があります。<strong>相続の開始と遺留分の侵害を知った時から1年</strong>、または<strong>相続開始から10年</strong>を過ぎると、請求できなくなります（民法1048条）。1年は短いため、侵害に気づいたら早めに、内容証明郵便などで請求の意思を示しておくのが一般的です。</p>'), ('相手が払わないとき', '<p>まずは当事者間の話し合いで金額を決めます。まとまらなければ、家庭裁判所の<strong>調停</strong>、それでも解決しなければ<strong>訴訟</strong>へ進みます。金額の評価や時効の管理は専門的なため、弁護士に相談しながら進めると確実です。具体的な計算や手続きは事案で変わるため、早めの相談をおすすめします。</p>')], 'faqs': [('兄弟姉妹にも遺留分はありますか？', 'ありません。遺留分が認められるのは配偶者・子（その代襲相続人）・直系尊属で、兄弟姉妹には遺留分がありません。そのため、兄弟姉妹に渡したくない場合は遺言が有効に働きます。'), ('不動産しかなくても金銭で請求するのですか？', 'はい。改正後は金銭債権なので、相手は原則お金で支払います。すぐに用意できない場合、相手は裁判所に支払いの期限の猶予を求めることができます。'), ('時効の1年はいつから数えますか？', '相続の開始と、遺留分を侵害する贈与・遺贈があったことの両方を知った時から1年です。知らなければ進行しませんが、相続開始から10年で一律に請求できなくなります。')]}, {'slug': 'will-storage-system', 'title': '自筆証書遺言書保管制度（法務局）｜手続き・費用・検認不要のメリット', 'h1': '法務局の自筆証書遺言書保管制度', 'desc': '2020年に始まった、自筆証書遺言を法務局が預かる「保管制度」を解説。紛失・改ざんを防げる、家庭裁判所の検認が不要になるといったメリットと、申請の手続き・手数料、公正証書遺言との違いを整理します。', 'keywords': '自筆証書遺言書保管制度,法務局,検認不要,手数料,2020年,遺言', 'lead': 'せっかく書いた自筆の遺言も、見つからない・捨てられる・書き換えられるリスクがあります。これを防ぐのが、2020年7月に始まった<strong>法務局の自筆証書遺言書保管制度</strong>です。仕組みとメリットを整理します。', 'sections': [('どんな制度か', '<p>自分で書いた<strong>自筆証書遺言</strong>を、法務局（遺言書保管所）に預けられる制度です。原本を法務局が保管し、画像データ化もされるため、紛失や改ざん、隠匿を防げます。自宅保管にありがちな「家族が見つけられない」「勝手に処分される」といった不安を減らせます。</p>'), ('大きなメリット：検認が不要', '<p>通常の自筆証書遺言は、相続開始後に家庭裁判所の<strong>検認</strong>という手続きが必要です。保管制度を使うと、この<strong>検認が不要</strong>になります。遺された家族の手間と時間を減らせるのは大きな利点です。</p><p>また、預ける際に形式（日付・署名・押印など）の<strong>外形的なチェック</strong>を受けられるため、方式不備で無効になるリスクも下げられます。</p>'), ('手続きと費用', '<ul><li>遺言者<strong>本人が、住所地・本籍地・所有不動産の所在地いずれかを管轄する法務局へ出向く</strong>（代理は不可）</li><li>所定の様式に従って書いた遺言書と申請書、本人確認書類などを持参</li><li>手数料は1件<strong>3,900円</strong>（保管申請の場合）</li></ul><p>金額や様式は変更されることがあるため、最新は法務省・法務局の公式案内で確認してください。</p>'), ('公正証書遺言との違い', '<p>公正証書遺言は公証人が関与し、内容面の信頼性が高い一方、費用は財産額に応じて高くなりがちです。保管制度は<strong>自分で書く手軽さと低コスト</strong>が魅力ですが、<strong>内容の有効性までは保証されません</strong>（チェックは形式面が中心）。確実さを重視するなら公正証書、手軽さと費用を重視するなら保管制度、と使い分けるとよいでしょう。</p>')], 'faqs': [('保管してもらえば内容も有効だと保証されますか？', 'いいえ。チェックされるのは日付・署名・押印といった形式（外形）が中心で、内容が有効かどうかや、争いになりにくいかまでは保証されません。内容の確実性を求める場合は公正証書遺言も検討してください。'), ('預けた後に検認は必要ですか？', '不要です。保管制度を利用した遺言は、相続開始後の家庭裁判所での検認手続きが不要になります。これは遺された家族の負担軽減につながります。'), ('家族が代わりに預けに行けますか？', 'できません。保管の申請は遺言者本人が法務局に出向いて行う必要があります。本人確認も行われます。')]}, {'slug': 'limited-acceptance', 'title': '限定承認とは｜相続放棄との違いと手続きの流れ・注意点', 'h1': '限定承認の仕組みと手続き', 'desc': 'プラスの財産の範囲でだけ借金を引き継ぐ「限定承認」を解説。相続放棄との違い、相続人全員で行う必要があることや3か月の期限、みなし譲渡課税などの注意点まで、選ぶ前に知っておきたい点を整理します。', 'keywords': '限定承認,相続放棄との違い,手続き,3か月,民法922条,みなし譲渡', 'lead': '「借金があるかもしれないが、プラスの財産も惜しい」——そんなときの選択肢が<strong>限定承認</strong>です。プラスの財産の範囲でのみ債務を引き継ぐ仕組みですが、手続きのハードルもあります。整理します。', 'sections': [('限定承認とは', '<p>限定承認は、相続で得たプラスの財産の範囲内でのみ、被相続人の債務を弁済する方法です（民法922条）。借金が財産を上回っていても、<strong>持ち出しでの返済は不要</strong>になります。逆に財産が余れば、それは相続できます。財産と借金のどちらが多いか分からないときに有効な選択肢です。</p>'), ('相続放棄との違い', '<ul><li><strong>相続放棄</strong>：プラスもマイナスも一切引き継がない（借金が明らかに多いとき向き）</li><li><strong>限定承認</strong>：プラスの範囲で借金を清算し、残れば受け取る（どちらが多いか不明なとき向き）</li></ul>'), ('手続きの流れと「全員で」の壁', '<p>限定承認は<strong>相続人全員が共同で</strong>行う必要があります（一人でも反対・単純承認すると使えません）。<strong>相続開始を知った時から3か月以内</strong>に、財産目録を添えて家庭裁判所へ申述します。その後、官報公告や債権者への弁済など、相続放棄より手間のかかる手続きが続きます。</p>'), ('見落としやすい税金の注意', '<p>限定承認では、相続財産を相続人へ時価で譲渡したとみなして<strong>譲渡所得税（みなし譲渡課税）</strong>が課されることがあります。被相続人の準確定申告が必要になる場合もあり、思わぬ税負担につながりかねません。手続きが煩雑で税務も絡むため、利用する際は弁護士・税理士に相談するのが安全です。最新の取扱いは公式情報で確認してください。</p>')], 'faqs': [('相続放棄と限定承認、どちらを選ぶべきですか？', '借金が明らかに多いなら相続放棄、財産と借金のどちらが多いか分からないなら限定承認が候補です。限定承認は手続きが重く全員の同意も必要なため、専門家に相談して判断するのが現実的です。'), ('相続人の一人が反対したら限定承認はできませんか？', 'できません。限定承認は相続人全員で共同して申述する必要があります。一人でも単純承認したり反対したりすると利用できないため、早めの合意形成が重要です。'), ('限定承認にも3か月の期限はありますか？', 'あります。相続の開始を知った時から原則3か月以内に、家庭裁判所へ申述する必要があります。財産調査が間に合わない場合は、期間の伸長を申し立てる方法もあります。')]}, {'slug': 'renounce-deadline-passed', 'title': '相続放棄の3か月が過ぎたら｜熟慮期間の伸長と例外的に認められるケース', 'h1': '相続放棄の期限が過ぎたとき', 'desc': '相続放棄の期限「3か月」を過ぎてしまった、間に合いそうにない——そんなときの対処を解説。後から借金が判明した場合の例外的な扱いや、財産調査が終わらないときの熟慮期間の伸長、単純承認とみなされる行為の注意点まで整理します。', 'keywords': '相続放棄,3ヶ月過ぎた,熟慮期間,伸長,単純承認,例外', 'lead': '相続放棄ができるのは「相続の開始を知った時から3か月」。この<strong>熟慮期間</strong>を過ぎると、原則として放棄できなくなります。ただし例外もあります。間に合わないとき・過ぎたときの対処を整理します。', 'sections': [('原則は「知った時から3か月」', '<p>相続放棄や限定承認ができる熟慮期間は、<strong>自分が相続人になったことを知った時から3か月</strong>です（民法915条）。この期間内に家庭裁判所へ申述しないと、原則として<strong>単純承認</strong>（プラスもマイナスも引き継ぐ）をしたものとして扱われます。</p>'), ('後から借金が判明したケース', '<p>「3か月以内には借金の存在をまったく知らず、後から督促が来て初めて分かった」という場合、<strong>借金の存在を知った時から3か月</strong>と扱われ、放棄が認められる余地があります（判例上の取り扱い）。ただし認められるかは事情によるため、督促などが来たら<strong>すぐに弁護士・司法書士に相談</strong>することが重要です。</p>'), ('間に合わないときは「期間の伸長」', '<p>財産調査が3か月で終わりそうにないときは、期限が来る前に家庭裁判所へ<strong>熟慮期間の伸長</strong>を申し立てることができます。認められれば、放棄するかどうかを判断する期間を延ばせます。期限が迫ってから慌てないよう、早めの検討が大切です。</p>'), ('やってはいけないこと（単純承認とみなされる行為）', '<p>放棄を考えているなら、<strong>遺産の処分（預金の引き出し・使い込み、不動産の名義変更、形見以外の財産の売却など）</strong>は避けましょう。これらは「単純承認した」とみなされ、もう放棄できなくなることがあります。葬儀費用の扱いなど判断が難しい点もあるため、迷ったら専門家に確認してください。</p>')], 'faqs': [('3か月を過ぎたら絶対に放棄できませんか？', '原則はできませんが、3か月以内に借金の存在を知り得なかったなどの事情があれば、知った時から3か月として認められる余地があります。事情により判断が分かれるため、早めに専門家へ相談してください。'), ('熟慮期間はどのくらい延ばせますか？', '家庭裁判所が事情に応じて判断します。財産調査に必要な範囲で延長が認められることが一般的です。延長は期限が過ぎる前に申し立てる必要があります。'), ('故人の預金で葬儀費用を払っても大丈夫ですか？', '状況により単純承認とみなされるリスクがあります。社会通念上相当な葬儀費用は問題になりにくいとされることもありますが、判断が難しいため、放棄を検討中なら事前に専門家へ相談するのが安全です。')]}, {'slug': 'koseki-fuhyo', 'title': '戸籍の附票とは｜住所の履歴をたどる・相続登記での使い道', 'h1': '戸籍の附票と相続での使い道', 'desc': '戸籍の附票は、その戸籍にいる間の住所の移り変わりを記録した書類です。相続登記で「登記簿の住所」と「最後の住所」のつながりを証明するのに使う場面や、住民票の除票との違い、取得方法（広域交付対応）を解説します。', 'keywords': '戸籍の附票,住所の履歴,相続登記,住民票の除票,広域交付', 'lead': '相続手続き、とくに不動産の<strong>相続登記</strong>でつまずきやすいのが「住所のつながりの証明」です。ここで役立つのが<strong>戸籍の附票</strong>。聞き慣れない書類ですが、使いどころを知ると手続きがスムーズになります。', 'sections': [('戸籍の附票とは', '<p>戸籍の附票は、その戸籍が作られてから（またはその戸籍に入ってから）の<strong>住所の移り変わりの記録</strong>です。本籍地の市区町村で、戸籍と一緒に管理されています。住民票が「今の住所」を示すのに対し、附票は<strong>住所の履歴</strong>を示すのが特徴です。</p>'), ('相続登記での使い道', '<p>不動産の登記簿に記録された所有者（被相続人）の住所が、亡くなった時点の住所と違うことはよくあります。引っ越しで住所が変わっているケースです。相続登記では、<strong>「登記簿上の住所」と「最後の住所」が同一人物のものだとつなげて証明</strong>する必要があり、ここで戸籍の附票（または住民票の除票）が使われます。</p>'), ('住民票の除票との違い', '<p>亡くなった方の最後の住所は<strong>住民票の除票</strong>でも確認できますが、過去の住所まで一度にたどりたいときは<strong>戸籍の附票</strong>が便利です。登記簿の古い住所から最後の住所まで履歴がつながれば、住所変更の証明として使えます。保存期間の関係で古い情報が取れないこともあり、その場合の代替手段は法務局や専門家に確認します。</p>'), ('取り方（広域交付にも対応）', '<p>本籍地の市区町村で取得しますが、2024年に始まった戸籍の<strong>広域交付</strong>により、本籍地以外の市区町村の窓口でもまとめて請求しやすくなりました（対象や運用は自治体で確認を）。相続では戸籍一式とあわせて取得すると、手続きがスムーズです。</p>')], 'faqs': [('戸籍の附票と住民票はどう違いますか？', '住民票は現在（または最後）の住所を示すのに対し、戸籍の附票はその戸籍にいる間の住所の履歴を示します。過去の住所までたどりたいときは附票が役立ちます。'), ('相続登記でなぜ附票が必要になるのですか？', '登記簿の所有者住所が引っ越しで変わっていると、登記簿上の人物と被相続人が同一だと証明する必要があります。住所の履歴をつなぐために、戸籍の附票や住民票の除票を使います。'), ('古い住所までさかのぼれますか？', '附票で過去の住所をたどれますが、保存期間の関係で古い情報が取得できないこともあります。その場合は、別の書類での証明や、法務局・専門家への相談で対応することになります。')]}]
